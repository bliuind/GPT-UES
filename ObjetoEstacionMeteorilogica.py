...
#Graficas 6. [1 - 2]
ET = 43 ;   Rain = 44;  HighRain = 45;  SolarRad = 46;  HighSolarRad = 47;
SolarE = 48;    UVIndex = 49;   HighUVIndex = 50;   UVDose = 51;
HeatD = 52;     CoolD = 53;


#Lectura del archivo, salto de filas, le decimos que no posee header
df = pd.read_csv('7GT-EEP_1-1-25_12-00_AM_1_Year_1779324867_v2_Recreated.csv', skiprows=0, encoding='utf-8-sig', header=None, dtype=str)
#df = pd.read_csv('7GT-UES_1-1-25_12-00_AM_1_Year_1779324630_v2_Recreated.csv', skiprows=0, encoding='utf-8-sig', header=None, dtype=str)
...
LabelMeses.append(Mes[0]);  LabelOpcionesMeses.append(Mes[0])
                    ...
                    children=[
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                ...
                                {'label': 'Viento y su direccion', 'value': 'Vientos'}                      #Opcion 5
                            ],
...
def actualizar_grafico_o_datos(estacion,opcion, indiceMesDCC, indiceDiaDCC):
    if(estacion == '-1'):
        print(estacion)
        return None,None,None, None,None,None,None, None,None,None, None,None,None,None
    else:
        if(estacion == '0'):
            df = pd.read_csv('7GT-EEP_1-1-25_12-00_AM_1_Year_1779324867_v2_Recreated.csv', skiprows=5, encoding='utf-8-sig', header=None, dtype=str)
            print(estacion)
        elif(estacion == '1'):
            df = pd.read_csv('7GT-UES_1-1-25_12-00_AM_1_Year_1779324630_v2_Recreated.csv', skiprows=5, encoding='utf-8-sig', header=None, dtype=str)
            print(estacion)
        if (indiceDiaDCC == - 1):
        ...
        if opcion == "Vientos":
            ...
            XlimInf2 = y3[0];    XlimSup2 = y3[len(y3) - 1];  Rango3 = int(RegladeSturges(y3[len(y3) - 1]))
        ...
        if opcion == "Sensaciones":
            ...
            BloqueW_H_THW = html.Div([
                html.Label(id='input-w-h-twh',style=label_style_minus,children=["'Enfriamento Eólico °C' 'Indice de Calor °C' 'THW °C' 'THSW °C'"]),
            ...
            XlimInf2 = y2[0];    XlimSup2 = y1[len(y1) - 1];  Rango = int(RegladeSturges(y1[len(y1) - 1]));
            ...
            BloqueHistWindCWindCMin = html.Div([
                ...
                html.Label(id='input-hist_wind_c_wind_c_min',style=label_style,children=['Enfriamento Eólico °C']),
                html.P([
                    html.Strong('Medias Aritméticas'),html.Br(),
            ...
            VarianzaInsesgadaHHeatI = Stats.DesviacionMediaVector(y3, Media3);
            ...
            XlimInf2 = y4[0];    XlimSup2 = y3[len(y3) - 1];  Rango = int(RegladeSturges(y3[len(y3) - 1]));
            ...
            BloqueHistHighHeatIndex = html.Div([
                ...
                html.Label(id='input-hist_high_heat_index',style=label_style,children=['Enfriamento Eólico °C']),
                html.P([
                    html.Strong('Medias Aritméticas'),html.Br(),
            ...
            XlimInf1 = y5[0];    XlimSup1 = y5[len(y5) - 1];  Rango5 = int(RegladeSturges(y1[len(y1) - 1]))
            ...
            XlimInf1 = y8[0];    XlimSup1 = y8[len(y8) - 1];  Rango8 = int(RegladeSturges(y8[len(y8) - 1]))
            ...
            XlimInf2 = y7[0];    XlimSup2 = y6[len(y6) - 1];  Rango = int(RegladeSturges(y7[len(y7) - 1]))
            ...
            XlimInf2 = y6[0];    XlimSup2 = y7[len(y7) - 1];  Rango = int(RegladeSturges(y7[len(y7) - 1]))
